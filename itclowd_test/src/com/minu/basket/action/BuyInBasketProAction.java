...
import com.minu.basket.svc.BasketCardService;
import com.minu.basket.svc.BasketMooTongJangService;
import com.minu.basket.vo.SonBean;
...
public class BuyInBasketProAction implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
		 ...
		 * 상품정보
		 */		
		SonBean list = new Gson().fromJson(req.getParameter("list"), SonBean.class);
		order.setBooks(list.getBooks());
		order.setBaskets(list.getBaskets());
		...
		if(buyMethod.equals("무통장 입금")) {
			...
			BasketMooTongJangService mooService = new BasketMooTongJangService(order);
			...
			BasketCardService cardService = new BasketCardService(order);
